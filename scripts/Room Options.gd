...
func _on_saveRoomOptions_pressed():
	...
	Json_Handler.Save_Room_Changes(Globals.current_world,Globals.current_room,"removeWater",RoomOptions.get_node("drainLiquids").pressed )
	...
	Json_Handler.Save_Room_Changes(Globals.current_world,Globals.current_room,"submerge",RoomOptions.get_node("submerge").pressed )
