...
var debug_test = true
func init_main():
	var scripts = ProjectSettings.load_resource_pack("res://pcks/scripts.pck",  debug_test)
	var door = ProjectSettings.load_resource_pack("res://pcks/door.pck",  debug_test)
	var item = ProjectSettings.load_resource_pack("res://pcks/item.pck",  debug_test)
	var liquid = ProjectSettings.load_resource_pack("res://pcks/liquid.pck",  debug_test)
	var transporter = ProjectSettings.load_resource_pack("res://pcks/transporter.pck",  debug_test)
	var pack = ProjectSettings.load_resource_pack("res://pcks/main.pck",  debug_test)
	if pack:
		var main = load("res://Panel.tscn")
